...
# I think this came from here: https://stackoverflow.com/questions/1489183/how-can-i-use-ruby-to-colorize-the-text-output-to-a-terminal
# rubocop made this ugly
class String
  def black
    "\e[30m#{self}\e[0m"
  end
